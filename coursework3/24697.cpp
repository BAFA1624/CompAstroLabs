...
class fluid_solver
{
    ...
    [[nodiscard]] constexpr auto q1() const noexcept {
        ...
        for ( std::size_t i{ 0 }; i < Size; ++i ) {
            q1_array[i] = m_state[i + static_cast<std::size_t>( Order )][0];
        }
        return q1_array;
    }
    [[nodiscard]] constexpr auto q2() const noexcept {
        ...
        for ( std::size_t i{ 0 }; i < Size; ++i ) {
            q2_array[i] = m_state[i + static_cast<std::size_t>( Order )][1];
        }
        return q2_array;
    }
    [[nodiscard]] constexpr auto q3() const noexcept {
        ...
        for ( std::size_t i{ 0 }; i < Size; ++i ) {
            q3_array[i] = m_state[i + static_cast<std::size_t>( Order )][2];
        }
        return q3_array;
    }
